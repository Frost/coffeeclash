...
if (Meteor.is_client) {
  ...
  Template.leaderboard.events = {
    'click input.inc': function () {
      ...
      Players.update(Session.get("selected_player"), {$push: {cups: cup}});
    }
  };
  ...
  Template.playerform.events = {
    'submit': function () {
      ...
      var player = Players.insert({name: name.val(), score: 0});
      Session.set("selected_player", player);
    }
  }

  Handlebars.registerHelper("numberOfCupsToday", function(cups) {
    if (cups) {
